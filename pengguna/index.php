				...
				<div class="col-md-8 order-md-last">
					<div class="row">
						<div class="col-md-6 text-center">
							<a class="navbar-brand" href="index.php">Digital <span>Library</span> <small>Man 2 Mojokerto</small></a>
						</div>
	    ...
	    <div class="container-fluid">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav m-auto">
	        	...
	        	<li class="nav-item"><a href="author.html" class="nav-link">Event</a></li>
	        	<li class="nav-item"><a href="blog.html" class="nav-link">Lomba</a></li>
	          <li class="nav-item"><a href="contact.html" class="nav-link">Usulan</a></li>
	        </ul>
	      </div>
	    </div>
	  </nav>
