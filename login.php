...
<html lang="en">
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <div class="ftco-blocks-cover-1">
      <div class="site-section-cover overlay" data-stellar-background-ratio="0.5" style="background-image: url('hadir/images/img_5.jpg')">
        <div class="container">
    ...
    <div class="card" style="position: center">
      ...
      <form>
        <div class="form-group"> 
          ...
          <input type="text" id="username" class="form-control form-control-sm" placeholder="Nama Anda">
        </div>
       
        <div class="form-group">
          <label for="pass">Password</label>
          <input type="password" id="nomor" class="form-control form-control-sm" placeholder="Password">
        </div>
